...
import { formatCitationsWithIds } from '../utils/formatCitations';
import { ChatMessage as ChatMessageType } from '../hooks/useAssistantChat';
...
const ChatMessage: React.FC<ChatMessageProps> = ({ message, annotationsMap, onCitationClick }) => {
  ...
  const processed = formatCitationsWithIds(message.content, annotationsMap);
